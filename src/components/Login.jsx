...
const Login = () => {
  ...
  return (
    <div>
        <div className="max-w-sm w-full text-white space-y-5 mx-auto">
                <form
                ...
                {/* <GoogleButton  className="mx-auto mt-10"/> */}
                <button className="w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg text-sm font-medium hover:bg-gray-50 duration-150 active:bg-gray-100 hover:text-neutral-900" onClick={handleGoogleSignIn}>

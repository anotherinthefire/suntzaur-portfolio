const Testimonial = () => {
  ...
  const testimonials = [
    {
      avatar: "https://upload.wikimedia.org/wikipedia/commons/c/c3/VPSDPortrait_%28cropped%29_%283%29.jpg",
      name: "Sara The Third",
      title: "DepEd Developer",
      quote: "Fei shang, gao shing, chi, shishyang, Chonghu, Guaja, Jushi, Xijingpin, Chunguju, Frelupin, Tashir, Wangshilian, Ho, Twenty, Chonghu, Gongmin, Chiri, Trali, Chingju, Chonghua, Renmin, Gonghu, Shangri, Chi Shirsan, Jonyen, Ju Twenty, Jonghu, Ren, Goching Kwai La."
    },
    {
      avatar: "https://i1.sndcdn.com/artworks-MmK0EBP5MuhKcc1Z-3lonmQ-t500x500.jpg",
      name: "Lyn",
      title: "Laz Veygaz Engineer",
      quote: "Hi I'm Lyn from laz Veygas! Mowdels wer hayring nyu fromotional mowdels tsu work in las veygas uwezey! Ar yu eten to tweny one yers owld do you hav kud engles iskels a fleseng fersenality and a desayr for an exciting nyu layf! eyp so dis ofertunity mibi fer yu if this sounds enteresting ples emel az so we can arenz your fersenal interfiew tanks!"
    },
    {
      avatar: "https://i.ytimg.com/vi/tGPT3DL25Ng/hq2.jpg?sqp=-oaymwEoCOADEOgC8quKqQMcGADwAQH4Ad4DgALgA4oCDAgAEAEYciBTKC8wDw==&rs=AOn4CLCr_zY1xlq5wLExy94E5WNeZVk1RQ",
      name: "Pizza Man",
      title: "Shakeys Designer",
      quote: "Umattend ako ng birthday party ng 1 year old sa Shakey's. Dumating yung mascot. Hindi pinasayaw. Yung host kumanta ng The Dawn. Hindi ko maintindihan ang nangyayari."
    },
  ]

  return (
    <div className="min-h-screen h-fit py-16">
      <section className="mt-10 pb-10">
        <div className="max-w-screen-xl mx-auto px-4 md:px-8">
          <div className="max-w-xl sm:text-center md:mx-auto">
            ...
            <p className="mt-3 text-gray-600white">
              working in progress
            </p>
          </div>
          <div className="mt-12">
                ...
                testimonials.map((item, idx) => (
                  <li key={idx} className="bg-white rounded-xl border shadow-md">
                    ...
                    <figure>
                      ...
                      <div className="flex items-center gap-x-4 p-4 mt-6 bg-red-50 rounded-lg">
      ...
      <dialog id="my_modal_4" className="modal">
        <form method="dialog" className="modal-box w-11/12 max-w-5xl">
          <h3 className="font-bold text-lg">Hello! (user name if logged in then none if not)</h3>
          <p className="py-4">tinatamad pa ko tapusin</p>
